 ...
 *
 * Cette classe représente un pavé, ou parallélépipède rectangle, défini par six faces planes (des Quad3D)
...
class Pave3D {
private:
    Quad3D front_quad;  ///< Face avant du pavé.
    Quad3D back_quad;   ///< Face arrière du pavé.
    Quad3D left_quad;   ///< Face gauche du pavé.
    Quad3D right_quad;  ///< Face droite du pavé.
    Quad3D top_quad;    ///< Face supérieure du pavé.
    Quad3D bottom_quad; ///< Face inférieure du pavé.
     ...
     * d'un pavé (parallélépipède rectangle). Elle vérifie notamment que :
...
public:
     ...
     *
     * Initialise un pavé avec des faces vides et une couleur par défaut (noir).
     */
    Pave3D();
    ...
    /**
     * @brief Accesseur pour la face avant du pavé.
     * @return La face avant du pavé (Quad3D).
     */
    Quad3D getFrontQuad() const;

    /**
     * @brief Accesseur pour la face arrière du pavé.
     * @return La face arrière du pavé (Quad3D).
     */
    Quad3D getBackQuad() const;

    /**
     * @brief Accesseur pour la face gauche du pavé.
     * @return La face gauche du pavé (Quad3D).
     */
    Quad3D getLeftQuad() const;

    /**
     * @brief Accesseur pour la face droite du pavé.
     * @return La face droite du pavé (Quad3D).
     */
    Quad3D getRightQuad() const;

    /**
     * @brief Accesseur pour la face supérieure du pavé.
     * @return La face supérieure du pavé (Quad3D).
     */
    Quad3D getTopQuad() const;

    /**
     * @brief Accesseur pour la face inférieure du pavé.
     * @return La face inférieure du pavé (Quad3D).
     */
    Quad3D getBottomQuad() const;
     ...
     *
     * Le volume est calculé en supposant que les dimensions sont données par les faces
     * avant/arrière, gauche/droite et supérieure/inférieure.
     * 
